#' AIF360 Binary Label Dataset
#' @description
#' Function to create AIF binary label dataset.
...
#' # Create aif binary label dataset
...
#' }
#' @seealso
#' \href{https://aif360.readthedocs.io/en/latest/modules/datasets.html#binary-label-dataset}{More about AIF binary label dataset.}
#' @export
