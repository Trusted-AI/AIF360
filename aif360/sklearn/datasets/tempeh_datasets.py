...
def fetch_lawschool_gpa(subset="all", usecols=[],
	...
	Note:
		By default, the data is downloaded from tempeh. See https://github.com/microsoft/tempeh
		for details.
	Args:
	...
	Returns:
		namedtuple: Tuple containing X, y, and sample_weights for the Law School GPA
	...
	return standardize_dataset(df, prot_attr=['race'],
							  target='zfygpa',
